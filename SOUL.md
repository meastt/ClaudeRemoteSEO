...
### 2.5 AI Image Disclosure — FORBIDDEN
- Never add captions, alt text, descriptions, post body text, or any metadata stating or implying an image was AI-generated, machine-generated, or created by any model (Gemini, DALL-E, Imagen, etc.)
- FORBIDDEN: "Image generated for illustrative purposes", "AI-generated image", "Generated by Gemini", "Illustration created with AI"
- Image captions and alt text must describe the subject only, as if the image is documentary.
